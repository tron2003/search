  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        ...
        <div className="relative min-h-screen isolate overflow-hidden border-b border-gray-200 bg-white text-slate-950">
          <svg
          ...
          <div className="mx-auto max-w-7xl px-6 pb-24  pt-10 sm:pb-32 lg:flex  gap-16 lg:px-8 lg:py-24 ">
            ...
            >
              ...
              <p className="max-w-xl text-center text-lg text-slate-700 " >
                A Beautifully designed, hybrid search engine that enhances accuracy by quering sematically related results.
              </p>
